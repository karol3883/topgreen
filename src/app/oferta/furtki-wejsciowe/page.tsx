...
const gallery = [
  { src: "/images/offers/thumbs/gate-concrete-1-640.jpg", label: "Wejście główne" },
  { src: "/images/offers/thumbs/fence-modern-1-640.jpg", label: "Domofon w słupku" },
  { src: "/images/offers/thumbs/gate-black-1-640.jpg", label: "Spójne wypełnienie" },
];
...
export default function FurtkiWejsciowePage() {
  return (
    <>
        ...
        <section className="relative overflow-hidden py-16 md:py-20">
          ...
          <div className="mx-auto grid w-[min(1140px,92vw)] gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <div>
              ...
              <h1 className="font-serif text-2xl md:text-3xl">Furtki wejściowe</h1>
              <p className="mt-4 text-lg text-tg-muted">
                Wejście dopasowane do całej kompozycji ogrodzenia. Opcje z domofonem, elektrozamkiem i
                spójnymi wypełnieniami.
              </p>
            </div>
            <div className="tg-card-lg reveal">
              ...
              <div className="mt-4 grid gap-3 text-sm text-tg-muted">
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  <span>Zamki</span>
                  <span className="font-semibold">Elektroniczne</span>
                </div>
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  <span>Domofon</span>
                  <span className="font-semibold">Audio / wideo</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Wypełnienie</span>
                  <span className="font-semibold">Dopasowane profile</span>
                </div>
              </div>
              <a
          ...
          <div className="mx-auto w-[min(1140px,92vw)]">
            <div className="mb-8 flex items-end justify-between">
              <div>
                ...
                <h2 className="mt-2 font-serif text-3xl">Furtki wejściowe</h2>
              </div>
