...
const gallery = [
  { src: "/images/offers/thumbs/gate-sliding-1-640.jpg", label: "Sterowanie aplikacją" },
  { src: "/images/offers/thumbs/gate-concrete-1-640.jpg", label: "Kontrola dostępu" },
  { src: "/images/offers/thumbs/fence-gate-iron-1-640.jpg", label: "Bezpieczeństwo" },
];
...
export default function AutomatykaKontrolaPage() {
  return (
    <>
        ...
        <section className="relative overflow-hidden py-16 md:py-20">
          ...
          <div className="mx-auto grid w-[min(1140px,92vw)] gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <div>
              ...
              <h1 className="font-serif text-2xl md:text-3xl">Automatyka i kontrola</h1>
              <p className="mt-4 text-lg text-tg-muted">
                Sterowanie dostępem, automatyka bram i integracje smart. Konfigurujemy system pod
                Twoje potrzeby i zapewniamy serwis.
              </p>
            </div>
            <div className="tg-card-lg reveal">
              ...
              <div className="mt-4 grid gap-3 text-sm text-tg-muted">
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  <span>Dostęp</span>
                  <span className="font-semibold">Czytniki / kody</span>
                </div>
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  <span>Integracje</span>
                  <span className="font-semibold">Aplikacja / smart home</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Serwis</span>
                  <span className="font-semibold">Wsparcie i gwarancja</span>
                </div>
              </div>
              <a
          ...
          <div className="mx-auto w-[min(1140px,92vw)]">
            <div className="mb-8 flex items-end justify-between">
              <div>
                ...
                <h2 className="mt-2 font-serif text-3xl">Automatyka i kontrola</h2>
              </div>
