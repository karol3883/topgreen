...
const gallery = [
  { src: "/images/offers/thumbs/fence-modern-1-640.jpg", label: "Linia pionowa" },
  { src: "/images/offers/thumbs/fence-brick-1-640.jpg", label: "Antracyt mat" },
  { src: "/images/offers/thumbs/gate-concrete-1-640.jpg", label: "Detale profili" },
];
...
export default function OgrodzeniaPalisadowePage() {
  return (
    <>
        ...
        <section className="relative overflow-hidden py-16 md:py-20">
          ...
          <div className="mx-auto grid w-[min(1140px,92vw)] gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <div>
              ...
              <h1 className="font-serif text-2xl md:text-3xl">Ogrodzenia palisadowe</h1>
              <p className="mt-4 text-lg text-tg-muted">
                Pionowe profile, minimalistyczna linia i wysoka sztywność. Idealne do nowoczesnej
                architektury i antracytowych wykończeń.
              </p>
            </div>
            <div className="tg-card-lg reveal">
              ...
              <div className="mt-4 grid gap-3 text-sm text-tg-muted">
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  <span>Profile</span>
                  <span className="font-semibold">[60x40 / 80x20]</span>
                </div>
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  <span>Prześwity</span>
                  <span className="font-semibold">[20–60mm]</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Wysokość</span>
                  <span className="font-semibold">[1.2–2.0m]</span>
                </div>
              </div>
              <a
          ...
          <div className="mx-auto w-[min(1140px,92vw)]">
            <div className="mb-8 flex items-end justify-between">
              <div>
                ...
                <h2 className="mt-2 font-serif text-3xl">Realizacje palisadowe</h2>
              </div>
