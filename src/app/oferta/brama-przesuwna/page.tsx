...
const gallery = [
  { src: "/images/offers/thumbs/gate-sliding-1-640.jpg", label: "Wjazd główny" },
  { src: "/images/offers/thumbs/gate-concrete-1-640.jpg", label: "Automatyka smart" },
  { src: "/images/offers/thumbs/gate-black-1-640.jpg", label: "Cichy napęd" },
];
...
export default function BramaPrzesuwnaPage() {
  return (
    <>
        ...
        <section className="relative overflow-hidden py-16 md:py-20">
          ...
          <div className="mx-auto grid w-[min(1140px,92vw)] gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <div>
              ...
              <h1 className="font-serif text-4xl md:text-5xl">Brama przesuwna</h1>
              <p className="mt-4 text-lg text-tg-muted">
                Komfortowe wjazdy, cicha praca i możliwość rozbudowy o automatykę smart. Idealne dla
                nowoczesnych posesji.
              </p>
            </div>
            <div className="tg-card-lg reveal">
              ...
              <div className="mt-4 grid gap-3 text-sm text-tg-muted">
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  <span>Napędy</span>
                  <span className="font-semibold">[Somfy / Nice]</span>
                </div>
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  <span>Sterowanie</span>
                  <span className="font-semibold">Pilot / aplikacja</span>
                </div>
          ...
          <div className="mx-auto w-[min(1140px,92vw)]">
            <div className="mb-8 flex items-end justify-between">
              <div>
                ...
                <h2 className="mt-2 font-serif text-3xl">Bramy przesuwne</h2>
              </div>
