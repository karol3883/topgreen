...
const gallery = [
  { src: "/images/offers/thumbs/fence-gate-iron-1-640.jpg", label: "Klasyczny wjazd" },
  { src: "/images/offers/thumbs/gate-black-1-640.jpg", label: "Dwuskrzydłowe" },
  { src: "/images/offers/thumbs/fence-modern-1-640.jpg", label: "Dopasowane słupy" },
];
...
export default function BramaSkrzydlowaPage() {
  return (
    <>
            ...
            <div className="tg-card-lg reveal">
              ...
              <div className="mt-4 grid gap-3 text-sm text-tg-muted">
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  ...
                  <span className="font-semibold">Pilot / klucz</span>
                </div>
                <div className="flex items-center justify-between border-b border-tg-line pb-2">
                  <span>Siłowniki</span>
                  <span className="font-semibold">Pod wymiar</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Styl</span>
                  <span className="font-semibold">Spójna furtka</span>
                </div>
              </div>
              <a
          ...
          <div className="mx-auto w-[min(1140px,92vw)]">
            <div className="mb-8 flex items-end justify-between">
              <div>
                ...
                <h2 className="mt-2 font-serif text-3xl">Bramy skrzydłowe</h2>
              </div>
